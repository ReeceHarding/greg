        ...
        <div className="container max-w-7xl">
          ...
          <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-3xl border border-primary/20 p-10 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/admin/reviews" className="p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-border hover:border-primary/30 hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-200 text-left group block">
                ...
                <p className="text-sm text-muted-foreground mb-3">{pendingSubmissions} assignments pending your review</p>
                <span className="text-sm font-medium text-primary group-hover:underline">Review Now →</span>
              </Link>

              <Link href="/admin/students" className="p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-border hover:border-primary/30 hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-200 text-left group block">
                <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-sm font-medium text-primary group-hover:underline">View Students →</span>
              </Link>

              <Link href="/admin/sessions" className="p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-border hover:border-primary/30 hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-200 text-left group block">
                <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
