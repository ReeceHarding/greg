/*
<ai_context>
This login page allows users to sign in with Google only.
...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.log("[Login Page] Session response status:", response.status)

      if (response.ok) {
        console.log("[Login Page] Session created successfully")
        ...
        console.error("[Login Page] Session creation failed:", errorData)
